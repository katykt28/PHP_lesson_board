...
<article>
    <div class="info">
        ...
        <p><a href="edit.php?message_id=<?php echo nl2br($value['id']); ?>">編集</a><a href="delete.php?message_id=<?php echo $value['id']; ?>">削除</a></p>
    </div>
...
<button onclick="location.href='index.php'" style="margin-top: 3px;">掲示板に戻る</button>
<?php endif; ?>
</section>
</body>
</html>